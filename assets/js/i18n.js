...
(function () {
  ...
  const STRINGS = {
    vi: {
      ...
      "admin.imgstaged": "Đã thêm ảnh vào bài — ảnh sẽ được tải lên cùng lúc khi bạn bấm Xuất bản.",
    ...
    en: {
      ...
      "admin.imgstaged": "Image added — it will be uploaded together with the article when you hit Publish.",
