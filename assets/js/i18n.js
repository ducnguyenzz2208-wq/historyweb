...
(function () {
  ...
  const STRINGS = {
    vi: {
      ...
      "admin.autotranslate": "🌐 Dịch tự động sang EN",
      "admin.autotranslate.vi": "🌐 Dịch tự động sang VI",
      "admin.translating": "Đang dịch tự động…",
      "admin.translated": "Đã dịch xong nội dung và các trường thông tin!",
      "admin.insertimg": "Chèn ảnh",
      "admin.caption": "Chú thích ảnh",
      "admin.position": "Vị trí",
      "admin.pos.right": "Nổi phải (Wikipedia)",
      "admin.pos.left": "Nổi trái (Wikipedia)",
      "admin.pos.center": "Toàn chiều rộng",
      "admin.stagedtray": "Khay ảnh đã đính kèm",
      "admin.setcover": "Đặt làm bìa",
      "admin.insertbtn": "Chèn vào bài",
      "admin.imgcount": "ảnh",
      "admin.modal.title": "Tải & Chèn Ảnh Thông Minh",
      "admin.modal.fromurl": "Nhập link ảnh ngoài (URL)",
      "admin.modal.choosefile": "Chọn một hoặc nhiều ảnh từ máy",
      "admin.modal.insert": "Chèn ảnh vào vị trí con trỏ",
      "admin.modal.close": "Đóng",

      "post.translatebtn": "🌐 Dịch bài này sang Tiếng Anh",
      "post.translating": "Đang dịch bài viết…",
      "post.translatednotice": "Bản dịch tự động được tạo trực tiếp bởi hệ thống.",
    ...
    en: {
      ...
      "admin.autotranslate": "🌐 Auto-translate to EN",
      "admin.autotranslate.vi": "🌐 Auto-translate to VI",
      "admin.translating": "Translating automatically…",
      "admin.translated": "Content and fields translated!",
      "admin.insertimg": "Insert image",
      "admin.caption": "Image caption",
      "admin.position": "Position",
      "admin.pos.right": "Float right (Wikipedia)",
      "admin.pos.left": "Float left (Wikipedia)",
      "admin.pos.center": "Full width",
      "admin.stagedtray": "Staged Images Tray",
      "admin.setcover": "Set as cover",
      "admin.insertbtn": "Insert into post",
      "admin.imgcount": "images",
      "admin.modal.title": "Upload & Insert Image",
      "admin.modal.fromurl": "Enter external image URL",
      "admin.modal.choosefile": "Choose one or more images from device",
      "admin.modal.insert": "Insert image at cursor",
      "admin.modal.close": "Close",

      "post.translatebtn": "🌐 Translate this article to English",
      "post.translating": "Translating article…",
      "post.translatednotice": "Auto-translated version generated on the fly.",
